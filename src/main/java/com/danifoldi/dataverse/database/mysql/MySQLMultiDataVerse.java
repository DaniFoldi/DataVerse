...
public class MySQLMultiDataVerse<T> extends NamespacedMultiDataVerse<T> {
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterMin(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength) {

        return databaseEngine.countDistinctFilterMin(namespace, filterKey, cutoff, pageCount, pageLength);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterMin(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength, FieldSpec sortKey, boolean reverse) {

        return databaseEngine.countDistinctFilterMin(namespace, filterKey, cutoff, pageCount, pageLength, sortKey, reverse);
    }
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterEquals(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength) {

        return databaseEngine.countDistinctFilterEquals(namespace, filterKey, cutoff, pageCount, pageLength);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterEquals(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength, FieldSpec sortKey, boolean reverse) {

        return databaseEngine.countDistinctFilterEquals(namespace, filterKey, cutoff, pageCount, pageLength, sortKey, reverse);
    }
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterMax(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength) {

        return databaseEngine.countDistinctFilterMax(namespace, filterKey, cutoff, pageCount, pageLength);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterMax(FieldSpec filterKey, BigDecimal cutoff, int pageCount, int pageLength, FieldSpec sortKey, boolean reverse) {

        return databaseEngine.countDistinctFilterMax(namespace, filterKey, cutoff, pageCount, pageLength, sortKey, reverse);
    }
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterBool(FieldSpec filterKey, boolean value, int pageCount, int pageLength) {

        return databaseEngine.countDistinctFilterBool(namespace, filterKey, value, pageCount, pageLength);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterBool(FieldSpec filterKey, boolean value, int pageCount, int pageLength, FieldSpec sortKey, boolean reverse) {

        return databaseEngine.countDistinctFilterBool(namespace, filterKey, value, pageCount, pageLength, sortKey, reverse);
    }
    ...
    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterPrefix(FieldSpec filterKey, String prefix, int pageCount, int pageLength) {

        return databaseEngine.countDistinctFilterPrefix(namespace, filterKey, prefix, pageCount, pageLength);
    }

    @Override
    public @NotNull CompletableFuture<@NotNull Long> countDistinctFilterPrefix(FieldSpec filterKey, String prefix, int pageCount, int pageLength, FieldSpec sortKey, boolean reverse) {

        return databaseEngine.countDistinctFilterPrefix(namespace, filterKey, prefix, pageCount, pageLength, sortKey, reverse);
    }
